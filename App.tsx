...
const App: React.FC = () => {
    ...
    const STEPS = t('steps') as StepType[];
        ...
        <div className="relative min-h-screen bg-slate-900 text-slate-200 flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8 font-sans">
            ...
            <div className="w-full max-w-4xl mx-auto">
                <header className="text-center mb-8">
                    ...
                    <p className="mt-2 text-slate-400">{t('guide.platformLabel')} <span className="font-semibold capitalize text-sky-400">{platform}</span></p>
                </header>
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl shadow-2xl shadow-slate-950/50 overflow-hidden">
                    ...
                    <div className="bg-slate-900/50 border-t border-slate-700 px-6 py-4 flex justify-between items-center">
                        ...
                        >
                            {currentStep === filteredSteps.length - 1 ? t('common.finish') : t('common.next')}
                        </button>
                    </div>
                </div>
